class Game {
  ...
  intro() {
    ...
    to('.start-game .section-1 .ball-demo', 0.5, { y: "0px", scaleY: 1, transformOrigin: "bottom", ease: Power2.easeOut,
      onStart: () => {
        ...
        TweenMax.to('.start-game .section-1 .ball-demo', 0.5, { backgroundImage: this.color });
      } });
  ...
  * Display score
   ...
   */
  showGrade(score) {
    if (score > 30) return "¡WOW!";else
    if (score > 25) return "Eres el jefe";else
    if (score > 20) return "Impresionante";else
    if (score > 15) return "Estupendo!";else
    if (score > 13) return "Bien!";else
    if (score > 10) return "Buen Trabajo!";else
    if (score > 5) return "En serio?";else
    return "Lo sentimos...";
  }
  ...
  bounce() {
    ...
    to('#ball', this.time / 2, { y: '-=250px', scaleY: 1.1, transformOrigin: "bottom", ease: Power2.easeOut,
      onStart: () => {
        ...
        this.prevColor = this.color;
        TweenMax.to('#ball', 0.5, { backgroundImage: this.color });
...
class Color {
  ...
  constructor() {
    this.colors = ["url(recursos/donaMorada.jpg)", "url(recursos/donaAmarilla.jpg)", "url(recursos/donaAzul.jpg)"];
  ...
  colorcodeToName(color) {
    let colors = ["url(recursos/donaMorada.jpg)", "url(recursos/donaAmarilla.jpg)", "url(recursos/donaAzul.jpg)"];
  ...
  changeColor(el) {
    ...
    if (index == 3) index = 0;
    el.
    css('background-image', this.colors[index]).
    data('index', index);
